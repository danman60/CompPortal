...
export default async function AddDancersPage() {
  ...
  if (userProfile?.role === 'studio_director') {
    ...
    // For admins, add requires studio selection
    return (
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black">
        <div className="container mx-auto px-4 py-8">
          <div className="bg-yellow-500/10 border border-yellow-400/30 rounded-lg p-6">
            ...
            <p className="text-yellow-300 mb-4">
              Adding dancers is currently available for studio directors only. Admins should use CSV import.
            </p>
            <Link
