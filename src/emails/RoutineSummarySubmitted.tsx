      ...
      <Body style={emailTheme.main}>
        <Container style={emailTheme.container}>
          ...
          <Section style={{...emailTheme.infoBox, borderLeft: `4px solid ${primaryColor}`}}>
            ...
            <Text style={{...emailTheme.text, fontSize: '14px', color: '#6b7280', marginTop: '12px'}}>
              The invoice with final pricing (including any discounts, taxes, and deposits) will be generated by the Competition Director.
            </Text>
