 ...
 * Fixed position at bottom on mobile devices (< md breakpoint)
...
export default function MobileBottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-black/90 backdrop-blur-xl border-t border-white/20 z-50 safe-area-inset-bottom">
