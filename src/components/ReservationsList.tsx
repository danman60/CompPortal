          ...
          {filteredReservations.map((reservation) => {
            ...
            return (
              ...
              >
                ...
                {/* Action: Generate Invoice (Competition Director Only) */}
                {!isStudioDirector && reservation.status === 'pending' && (
                  <div className="mt-6 pt-6 border-t border-white/10 flex gap-4">
                    <button
                      onClick={() => createInvoiceMutation.mutate({ reservationId: reservation.id, spacesConfirmed: reservation.spaces_requested || 0 })}
                    ...
                    >
                      {processingId === reservation.id && createInvoiceMutation.isPending
                        ? 'Generating Invoice...'
                        : 'Generate Invoice'}
                      }
                    </button>
