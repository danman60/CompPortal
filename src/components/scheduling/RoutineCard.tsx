...
export function RoutineCard({
  ...
  const getBorderStyle = () => {
    ...
    if (isLastRoutine) return 'border-2 border-yellow-400/70'; // Gold border for trophy helper
    if (hasConflict) {
      if (conflictSeverity === 'critical') return 'border-2 border-red-500/70';
      if (conflictSeverity === 'error') return 'border-2 border-orange-500/70';
      return 'border-2 border-yellow-500/70';
    }
