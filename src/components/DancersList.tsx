    ...
    <div>
      ...
      {timeAgo && (
        <div className="flex justify-end mb-4">
          <div className="text-xs text-gray-400/80 flex items-center gap-1" suppressHydrationWarning>
            ...
            <table className="w-full table-fixed">
              <thead>
                <tr className="bg-gray-800">
                  ...
                  <SortableHeader label="Classification" sortKey="classifications.name" sortConfig={sortConfig} onSort={requestSort} className="bg-gray-800" style={{ width: '180px' }} />
                  <SortableHeader label="Studio" sortKey="studios.name" sortConfig={sortConfig} onSort={requestSort} className="bg-gray-800" style={{ width: '200px' }} />
              ...
              <tbody>
                {sortedDancers.map((dancer, index) => {
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-gray-300" style={{ width: '200px' }}>
