...
- Professional dark-themed email consistent with existing styles.
- Personalized greeting with name and account email shown.
- Getting Started steps (4 items) and a CTA button to the dashboard.
- Branding via primary/secondary colors; emoji-only iconography.
