/**
 * Send Glow Invoice Summary TABLE v2 - includes credit notes
 */
    ...
    <div class="content">
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td class="note">10% studio discount</td>
            <td class="money credit">-$50.00</td>
            <td class="note">GLOW DOLLARS</td>
          ...
          <tr>
            ...
            <td class="note"><strong>Glow Dollars + Injury Credit for Glow Experience</strong></td>
            <td class="money">$500.00</td>
          ...
          <tr>
            ...
            <td class="note">Credit adjustment</td>
            <td class="money">$500.00</td>
          ...
          <tr>
            ...
            <td class="note">10% Discount</td>
            <td class="money credit">-$100.00</td>
            <td class="note">Glow$</td>
          ...
          <tr class="total-row">
            <td colspan="12">TOTAL (7 studios, 8 invoices)</td>
            <td class="money owed">$46,533.00</td>
          </tr>
          <tr class="hold">
            <td>Dancepirations</td>
            <td>Blue Mountain</td>
            <td colspan="6">HOLD - Suspicious $16,250.32 deposit + possible missing $425 GLOW DOLLARS</td>
            <td class="money credit">-$1,004.69</td>
            <td class="note" style="color:#dc2626;"><strong>Credit for Noemi = $1004.69 + GLOW DOLLARS $425 (is $425 missing?)</strong></td>
            <td class="money">$16,250.32</td>
      ...
      <div style="margin-top:24px; padding:16px; background:#dbeafe; border-radius:8px;">
        ...
        <ul style="color:#1e3a8a; margin:8px 0 0 0; padding-left:20px; font-size:13px;">
          ...
          <li><strong style="color:#dc2626;">Dancepirations ON HOLD:</strong> (1) $16,250.32 deposit seems wrong (2) Note mentions "$425 GLOW DOLLARS" but only $1,004.69 in other_credit</li>
        </ul>
      </div>
    </div>
...
async function send() {
  console.log('Sending Glow TABLE v2 with credit notes...');

  const result = await sendEmail({
    to: 'danieljohnabrahamson@gmail.com',
    subject: 'GLOW Invoice Summary v2 (with Credit Notes) - December 23, 2025',
    html,
    templateType: 'admin-summary',
  });

  if (result.success) {
    console.log('✓ Table v2 email sent!');
  } else {
