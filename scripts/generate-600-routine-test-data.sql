-- ============================================================================
-- Comprehensive 600-Routine Test Data for Tester Tenant
-- ============================================================================
...
VALUES
  ...
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Rhythm & Motion Dance Studio', 'contact@rhythmmotion.com', '555-0102', '456 Oak Ave', 'Madison', 'WI', '53703', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Elite Dance Company', 'admin@elitedance.com', '555-0103', '789 Elm St', 'Chicago', 'IL', '60601', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Grace Ballet School', 'info@graceballet.com', '555-0104', '321 Pine Rd', 'Milwaukee', 'WI', '53202', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Broadway Bound Dance Studio', 'hello@broadwaybound.com', '555-0105', '654 Maple Dr', 'Indianapolis', 'IN', '46204', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Center Stage Dance Academy', 'info@centerstage.com', '555-0106', '987 Cedar Ln', 'Detroit', 'MI', '48201', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Fusion Dance Collective', 'contact@fusiondance.com', '555-0107', '147 Birch St', 'Columbus', 'OH', '43215', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Momentum Dance Studio', 'info@momentumdance.com', '555-0108', '258 Willow Way', 'Minneapolis', 'MN', '55401', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Spotlight Performing Arts', 'admin@spotlightpa.com', '555-0109', '369 Ash Ave', 'St. Louis', 'MO', '63101', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Encore Dance Academy', 'hello@encoredance.com', '555-0110', '741 Spruce Dr', 'Kansas City', 'MO', '64101', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Prima Dance Studio', 'info@primadance.com', '555-0111', '852 Cypress Ln', 'Cincinnati', 'OH', '45202', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Velocity Dance Company', 'contact@velocitydance.com', '555-0112', '963 Poplar St', 'Cleveland', 'OH', '44113', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Elevate Dance Studio', 'info@elevatedance.com', '555-0113', '159 Walnut Rd', 'Omaha', 'NE', '68102', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Infinity Dance Center', 'admin@infinitydance.com', '555-0114', '357 Chestnut Ave', 'Des Moines', 'IA', '50309', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Harmony Dance Academy', 'hello@harmonydance.com', '555-0115', '486 Magnolia Dr', 'Rockford', 'IL', '61101', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Radiance Dance Studio', 'info@radiancedance.com', '555-0116', '753 Dogwood Way', 'Peoria', 'IL', '61602', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Synergy Dance Collective', 'contact@synergydance.com', '555-0117', '951 Hickory Ln', 'Grand Rapids', 'MI', '49503', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Apex Dance Company', 'info@apexdance.com', '555-0118', '842 Sycamore St', 'Dayton', 'OH', '45402', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Pinnacle Dance Studio', 'admin@pinnacledance.com', '555-0119', '267 Redwood Ave', 'Toledo', 'OH', '43604', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Legacy Dance Academy', 'hello@legacydance.com', '555-0120', '584 Laurel Dr', 'Fort Wayne', 'IN', '46802', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Prestige Dance Center', 'info@prestigedance.com', '555-0121', '692 Hawthorn Rd', 'Evansville', 'IN', '47708', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Phoenix Dance Studio', 'contact@phoenixdance.com', '555-0122', '418 Juniper Way', 'South Bend', 'IN', '46601', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Zenith Dance Company', 'info@zenithdance.com', '555-0123', '829 Beech Ln', 'Green Bay', 'WI', '54301', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Eclipse Dance Academy', 'admin@eclipsedance.com', '555-0124', '537 Alder St', 'Lansing', 'MI', '48933', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Cascade Dance Studio', 'hello@cascadedance.com', '555-0125', '946 Fir Ave', 'Ann Arbor', 'MI', '48104', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Triumph Dance Center', 'info@triumphdance.com', '555-0126', '173 Aspen Dr', 'Rochester', 'MN', '55901', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Odyssey Dance Collective', 'contact@odysseydance.com', '555-0127', '462 Cottonwood Rd', 'Duluth', 'MN', '55802', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Aspire Dance Studio', 'info@aspiredance.com', '555-0128', '795 Hemlock Way', 'Bloomington', 'IN', '47401', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Summit Dance Academy', 'admin@summitdance.com', '555-0129', '381 Mulberry Ln', 'Cedar Rapids', 'IA', '52401', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Inspire Dance Company', 'hello@inspiredance.com', '555-0130', '628 Sequoia St', 'Wichita', 'KS', '67202', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Evolution Dance Studio', 'info@evolutiondance.com', '555-0131', '914 Rosewood Ave', 'Aurora', 'IL', '60505', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Virtuoso Dance Center', 'contact@virtuosodance.com', '555-0132', '246 Basswood Dr', 'Naperville', 'IL', '60540', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Renaissance Dance Academy', 'info@renaissancedance.com', '555-0133', '573 Buttonwood Rd', 'Joliet', 'IL', '60432', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Catalyst Dance Studio', 'admin@catalystdance.com', '555-0134', '817 Willowood Way', 'Warren', 'MI', '48089', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Kinetic Dance Collective', 'hello@kineticdance.com', '555-0135', '492 Firwood Ln', 'Sterling Heights', 'MI', '48310', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Dynasty Dance Company', 'info@dynastydance.com', '555-0136', '685 Oakwood St', 'Sioux Falls', 'SD', '57104', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Precision Dance Studio', 'contact@precisiondance.com', '555-0137', '328 Pinewood Ave', 'Fargo', 'ND', '58102', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Majesty Dance Academy', 'info@majestydance.com', '555-0138', '754 Maplewood Dr', 'Lincoln', 'NE', '68508', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Serenity Dance Center', 'admin@serenitydance.com', '555-0139', '916 Cedarwood Rd', 'Topeka', 'KS', '66603', 'active', NOW(), NOW()),
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000003', 'Luminous Dance Studio', 'hello@luminousdance.com', '555-0140', '241 Elmwood Way', 'Springfield', 'MO', '65806', 'active', NOW(), NOW())
RETURNING id, name;
...
-- ============================================================================
-- RESERVATIONS (40 reservations, 15 tokens each = 600 total)
-- ============================================================================
...
-- Store reservation IDs for reference
...
-- ============================================================================
-- DANCERS (40-75 per studio = ~2,200 dancers total)
-- ============================================================================
...
-- Store dancer IDs by studio for linking
...
-- ============================================================================
-- COMPETITION ENTRIES (600 routines)
-- ============================================================================
...
-- Store entry IDs for linking participants
