/**
 * Send Dancepirations correction email
 * Has prior payments totaling $16,250.32
 *
 * Run with: npx tsx scripts/glow-emails/05-send-dancepirations.ts
 */
...
// Verified from database 2025-12-23
// Payments: $6,750.32 + $9,000 + $500 deposit = $16,250.32
const studio = {
  name: 'Dancepirations',
  email: 'dancepirationsacademy@gmail.com',
  competition: 'GLOW Blue Mountain Spring 2026',
  // 3 Production entries: Beauty & the Beast (44p), Lift Me Up (20p), Welcome to Wonderland (22p)
  productionEntries: 'Beauty & the Beast, Lift Me Up, Welcome to Wonderland',
  participants: 86, // 44 + 20 + 22
  productionFee: 4730.00, // 86 × $55
  correctedTotal: 21060.73,
  amountPaid: 16250.32, // $6,750.32 + $9,000 + $500 deposit
  balanceDue: 4810.41,
  subdomain: 'glow',
  studioId: 'b188e351-c19a-4bae-ba8d-af13f853f842',
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                We discovered a billing error that affected your invoice for <strong>${studio.competition}</strong>. This email contains your corrected invoice details and updated balance.
              </p>
              <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px 20px; border-radius: 0 8px 8px 0; margin: 24px 0;">
                ...
                <p style="color: #78350f; font-size: 14px; margin: 8px 0 0 0;">
                  Due to a system configuration error, your <strong>Production</strong> entries were incorrectly billed at <strong>$0</strong> instead of the correct fee of <strong>$55 per participant</strong>.
                </p>
                <p style="color: #78350f; font-size: 14px; margin: 8px 0 0 0;">
                  You can verify this by reviewing your previous invoice, where the Production entries (${studio.productionEntries}) show $0 fees.
                </p>
              </div>
              <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
              ...
              <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                A corrected invoice has been generated and is available in your studio portal. Your previous payments have been credited, so only the balance shown above is due.
              </p>
...
async function sendDancepirationsEmail() {
  console.log('=== Dancepirations - Production Fee Correction ===\n');
  console.log(`${studio.name}: ${studio.email}`);
  console.log(`  Production entries: ${studio.productionEntries}`);
  console.log(`  Total: ${studio.participants}p × $55 = $${studio.productionFee}`);
  console.log(`  Already Paid: $${studio.amountPaid} | Balance Due: $${studio.balanceDue}`);
...
sendDancepirationsEmail().catch(console.error);
