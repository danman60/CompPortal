/**
 * TEST Glow email to danieljohnabrahamson@gmail.com
 * Run with: npx tsx scripts/glow-emails/01-test-glow-email.ts
 */
...
// Test with Cassiahs data - IDs verified from database
const studio = {
...
async function test() {
  console.log('Sending TEST Glow email to danieljohnabrahamson@gmail.com...');
  console.log('Studio: Cassiahs Dance Company');
  console.log('Balance Due: $2,323.84');

  const result = await sendEmail({
    to: 'danieljohnabrahamson@gmail.com',
    subject: '[TEST] Invoice Correction - GLOW Blue Mountain Spring 2026 - Cassiahs Dance Company',
    html,
